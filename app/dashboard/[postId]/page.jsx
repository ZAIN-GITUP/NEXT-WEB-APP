...
import Postdatanotavialble from "./postdatanotavialble/page";
...
<Postbuttomsection/>
  ...
  return (
    ...
    <div className="flex container h-fit w-full  lx :w-full">
    <div className="container mx-auto -mt-8"><div className='h-dvh mt-0 w-48 fixed sm:fixed md:fixed lg:fixed'>
   <Sidebar/>
   </div>
      ...
      <div className="bg-white  mt-8 p-1 ml-44 h-auto rounded-md shadow-md">
